  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full flex-grow flex flex-col justify-center gap-12 -mt-4 md:-mt-8 lg:-mt-12">
        ...
        >
          <h1 className="font-extrabold text-gray-900 dark:text-white leading-[1.05] tracking-tight mb-2 font-inter" style={{ fontSize: "clamp(2.5rem, 6.5vw, 6.2rem)" }}>
            AI & Intelligent <br />
            automation
            
            {/* Split teal/dark square icon inside title */}
            <motion.div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end w-full mt-4">
          ...
          >
            Empowering modern enterprises with autonomous AI agents, secure vector cognitive layers, custom LLM fine-tuning, and robust automated decisions integrated with top-tier orchestrators like n8n, Lindy, Make, Zapier, and OpenClaw built to scale operations exponentially.
          </motion.div>
